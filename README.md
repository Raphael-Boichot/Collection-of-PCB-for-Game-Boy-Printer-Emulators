...
You can modify and copy the source files or sell these PCBs bare or populated as long as you respect the license terms (in brief, cite Raphaël BOICHOT and [Brian KHUU](https://github.com/mofosyne)). 

Want to buy a [Retrospy Pixel GameBoy Printer Emulator](https://retro-spy.com/product/pixel-gameboy-printer/) ? The product is just the **exact [Game Boy Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator)** flashed on Arduino Nano and hidden in a 3D printed shell, with the **exact same pinout**. In other words: a lazy attempt to make a profit on something that has been done for free by passionate people. It comes with a barely functional image converter. The PCBs proposed here are totally identical, for a fraction of the proposed price. If you've really got money to burn and want to avoid the hassle of ordering parts / waiting / soldering, it's better to buy a [well-finished product](https://gameboyphoto.bigcartel.com/product/bitboy) that retributes its true authors. At least you'll get what you pay for.
