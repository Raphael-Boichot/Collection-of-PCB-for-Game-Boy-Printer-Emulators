...
Want to buy a [Retrospy Pixel GameBoy Printer Emulator](https://retro-spy.com/product/pixel-gameboy-printer/) ? The product as you will get it from Retrospy is just a plain [Arduino Game Boy Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) flashed on Arduino Nano and hidden in a 3D printed shell (I translate: making profit on a community that makes this amazing emulator for free), coming along with a proprietary image converter light years below open sourced ones. The PCBs proposed here were tested with Retrospy software suite and are **of course 100% compatible**, for a fraction of the proposed price. If you've really got money to burn and want to avoid the hassle of ordering parts / waiting / soldering, it's better to buy a [well-finished product](https://gameboyphoto.bigcartel.com/product/bitboy) that retributes its true authors. At least you'll get what you pay for.
