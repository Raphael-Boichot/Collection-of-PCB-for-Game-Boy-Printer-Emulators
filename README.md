...
- All the GB printer Arduino projects (see notes)
...
**Sidenote:**
This board id also compatible with the Arduino based projects if you compile them with the [Earle Philhower RP2040 core](https://github.com/earlephilhower/arduino-pico) installed on Arduino IDE. Just route [LED_STATUS_PIN to pin D8 instead of D13](https://github.com/mofosyne/arduino-gameboy-printer-emulator/blob/30b91fd60cae8a97a446764cba289b109bcb47d4/GameBoyPrinterEmulator/GameBoyPrinterEmulator.ino#L88) and [GBP_SO_PIN to D0 instead of D4](https://github.com/mofosyne/arduino-gameboy-printer-emulator/blob/30b91fd60cae8a97a446764cba289b109bcb47d4/GameBoyPrinterEmulator/GameBoyPrinterEmulator.ino#L83). The Waveshare RP2040 Zero is equipped with a fancy WS2812 as internal LED which is not driven in the project linked here, sadly. It's up to you to code a basic controller for it (like in the picture above).
