...
Want to buy a [Retrospy Pixel GameBoy Printer Emulator](https://retro-spy.com/product/pixel-gameboy-printer/) ? The product is just a plain [Arduino Game Boy Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) flashed on Arduino Nano and hidden in a 3D printed shell (I translate: an attempt to make profit on this amazing emulator made for free by passionate people). It comes with a very minimal proprietary image converter. The PCBs proposed here are totally identical, for a fraction of the proposed price. If you've really got money to burn and want to avoid the hassle of ordering parts / waiting / soldering, it's better to buy a [well-finished product](https://gameboyphoto.bigcartel.com/product/bitboy) that retributes its true authors. At least you'll get what you pay for.
