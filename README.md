...
Want to buy a [Retrospy Pixel GameBoy Printer Emulator](https://retro-spy.com/product/pixel-gameboy-printer/) ? The product is just the **exact [Arduino Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator)** flashed on Arduino Nano and hidden in a 3D printed shell, with the **exact same pinout** (other said: a scam). It's the laziest possible attempt to make profit on the work done for free by passionate people I ever saw. The PCBs proposed here are totally compatible for a fraction of the proposed price. If you're not into DIY/programming stuff and want to burn money, better buy a [well-finished product](https://gameboyphoto.bigcartel.com/product/bitboy) that retributes its true authors. At least you'll get your money's worth.
